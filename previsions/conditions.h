...
public:
    ...
    Conditions(const bool ecl, const bool ext, const int crep, const int haut, const int pas0, const double dtu, const double jj1, const double jj2, const double mgn1, const QString fic, const QString out, const QString unite, const QStringList listeSatellites);

    // Constructeur pour le calcul des flashs Iridium
    Conditions(const bool ext, const int crep, const int haut, const int nbl, const char chr, const char ope, const double ang0, const double dtu, const double jj1, const double jj2, const double mgn1, const double mgn2, const QString fic, const QString out, const QString unite);

    // Constructeur pour le calcul des evenements orbitaux
    Conditions(const bool apassApogee, const bool apassNoeuds, const bool apassOmbre, const bool apassPso, const bool atransJn, const double dtu, const double jj1, const double jj2, const QString fic, const QString out, const QString unite, const QStringList listeSatellites);

    // Constructeur pour le calcul des transits ISS
    Conditions(const bool acalcLune, const bool acalcSoleil, const int haut, const double ageTLE, const double seuilConjonction, const double dtu, const double jj1, const double jj2, const QString fic, const QString out, const QString unite);
